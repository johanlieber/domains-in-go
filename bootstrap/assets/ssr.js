...
var M = (t) => m("before", { cancelable: true, detail: { visit: t } }), H = (t) => m("error", { detail: { errors: t } }), $ = (t) => m("exception", { cancelable: true, detail: { exception: t } }), N = (t) => m("finish", { detail: { visit: t } }), q = (t) => m("invalid", { cancelable: true, detail: { response: t } }), x = (t) => m("navigate", { detail: { page: t } }), W = (t) => m("progress", { detail: { progress: t } }), X = (t) => m("start", { detail: { visit: t } }), K = (t) => m("success", { detail: { page: t } });
function I(t) {
...
function k(t, e, i, n = "brackets") {
  ...
  return t === "get" && Object.keys(i).length && (c.search = lib.stringify(ne(lib.parse(c.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[s2 ? `${c.protocol}//${c.host}` : "", l ? c.pathname : "", h2 ? c.pathname.substring(1) : "", g2 ? c.search : "", f ? c.hash : ""].join(""), i];
}
function w(t) {
...
var Q = typeof window > "u", C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: s2 = false, preserveScroll: l = false, preserveState: h2 = false, only: g2 = [], except: f = [], headers: c = {}, errorBag: o = "", forceFormData: v = false, onCancelToken: T = () => {
    ...
    axios({ method: i, url: w(S).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...c, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...j ? { "X-Inertia-Partial-Component": this.page.component } : {}, ...g2.length ? { "X-Inertia-Partial-Data": g2.join(",") } : {}, ...f.length ? { "X-Inertia-Partial-Except": f.join(",") } : {}, ...o && o.length ? { "X-Inertia-Error-Bag": o } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
...
d(
  (page) => createInertiaApp({
    page,
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Home/Index.svelte": __vite_glob_0_0 });
